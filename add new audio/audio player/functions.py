...
csv_file =os.path.join(script_directory,"broken_3s_audio_data.csv")
header=[]
...
def savedata(Data=data, Header=header, csv_file=os.path.join(script_directory,"broken_3s_audio_data.csv")):
